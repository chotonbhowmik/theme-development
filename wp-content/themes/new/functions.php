	...
	function new_setup() {
		...
		register_nav_menus(
			array(
				...
				'secondary' => __( 'Secondary Menu', 'new' ),
			)
		);
		...
		function choton_widgets(){
			//sidebar
			register_sidebar(array(
				'name' => __('Footer Widget 1', 'new'),
				'id' => 'footer_widget1',
				'description' => __('Footer widget', 'new'),
				'before_widgets' => '<div class="single-footer footer-logo">',
				'after_widgets' =>'</div>',
				'before_title' => '<h3>',
				'after_title' =>'</h3>',
			));
			...
			register_sidebar(array(
				'name' => __('Footer Widget 2', 'new'),
				'id' => 'footer_widget2',
				'description' => __('Footer widget', 'new'),
				'before_widgets' => '<div class="single-footer">',
				'after_widgets' =>'</div>',
				'before_title' => '<h4>',
				'after_title' =>'</h4>',
			));
...
register_sidebar(array(
				'name' => __('Footer Widget 4', 'new'),
				'id' => 'footer_widget4',
				'description' => __('Footer widget', 'new'),
				'before_widgets' => '<div class="single-footer contact-box">',
				'after_widgets' =>'</div>',
				'before_title' => '<h4>',
				'after_title' =>'</h4>',
			));
		...
		add_action('widgets_init', 'choton_widgets');
...
require_once get_template_directory(). '/inc/choton-activation.php';
